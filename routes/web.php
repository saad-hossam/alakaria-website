...
Route::group(
    ...
    function () {
        ...
        Route::get('/our-vision',  [AboutController::class, 'vision'])->name('vision');
        Route::get('/our-message',  [AboutController::class, 'message'])->name('message');
        Route::get('/our-goal',  [AboutController::class, 'goal'])->name('goal');
        // Route::get('/products-detail', [HomeController::class, 'product_details'])->name('details');
