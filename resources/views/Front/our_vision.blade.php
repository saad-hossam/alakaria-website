...
@section('content')
    ...
    <div class="container-fluid page-header bg-primary py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">{{trans('about.vision_title')}}</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="#">{{trans('home.house')}}</a></li>
                    <li class="breadcrumb-item"><a href="#"></a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{trans('about.vision_title')}}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 wow fadeInUp bg-white" data-wow-delay="0.1s">
            <div class="rounded p-1 bg-light">
              <div class="icon my-3 text-center">
                <img src="img/icon-01.png" class="img-responsive" alt="{{trans('pagination.alt_title')}}" />
              </div>

              <h5 class="text-center">{{ __('about.vision_title') }}</h5>
