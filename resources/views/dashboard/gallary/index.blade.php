...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الصور</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                الصور</span>
        </div>
    </div>
    @can('gallary-create')
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('gallaries.create') }}">اضافه صوره</a>
    </div>
    @endcan
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">الترتيب</th>
                             ...
                             @foreach ($gallaries as $gallary)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('gallaries.edit', $gallary->id) }}" class="btn btn-sm btn-info"
                                            title="تعديل"><i class="las la-pen"></i></a>
                                        @endcan
                                        @can('gallary-delete')
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $gallary->id }}" data-username="{{ $gallary->name }}"
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('gallaries.destroy',0) }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <p>هل انت متاكد من عملية الحذف ؟</p><br>
                        <input type="hidden" name="gallary_id" id="user_id" value="">
