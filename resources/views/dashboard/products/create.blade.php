        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('products.store') }}" class="needs-validation " enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif" id="{{ $key }}" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="form-group mt-3 col-md-12">
                                            <label> وصف-- {{ $lang }}</label>
                                            <textarea id="Product_description_{{$key }}" name="{{$key}}[description]"  class="form-control" placeholder="Textarea" rows="5"></textarea>
                                            {{-- <input type="text" name="{{$key}}[description]" class="form-control" placeholder="الاسم"> --}}
                                        </div>
                                        <div class="form-group mt-3 col-md-12">
                                            <label> مقال-- {{ $lang }}</label>
                                            <textarea id="Product_body_{{$key }}" name="{{$key}}[body]"  class="form-control" placeholder="Textarea" rows="5"></textarea>
                                            {{-- <input type="text" name="{{$key}}[body]" class="form-control" placeholder="الاسم"> --}}
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="سعر المنتج" type="number" name="price"  value="{{ old('price') }}">
                                </div><!-- main-form-group -->
                            </div>
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                ...
                                <label class="ckbox"><input name="sale" value="true" type="checkbox"><span>خصومات</span></label>
                            </div>
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
