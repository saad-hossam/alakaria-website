                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">عروض</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($product->sale == 'onsale')
                                            <span class="label text-success  d-flex  " style="margin-right: 50px;">
                                                <div class="dot-label bg-success "></div>داخل العرض
                                            </span>
                                        @else
                                            <span class="label text-danger  d-flex " style="margin-right: 50px;">
                                                <div class="dot-label bg-danger "></div>خارج العرض
                                            </span>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $product->id }}" data-username="{{ $product->name }}"
