...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">التواريخ</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                التواريخ</span>
        </div>
    </div>
    @can('history-create')
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('histories.create') }}">اضافه تاريخ</a>
    </div>
    @endcan
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">اسم الحقبة</th>
                                <th class="wd-15p border-bottom-0">محتوى الحقبة </th>
                                <th class="wd-15p border-bottom-0">صورة الحقبة</th>
                                <th class="wd-15p border-bottom-0">حالة الحقبة </th>
                            ...
                            @if ($histories->count()>0)
                             @foreach ($histories as $history)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('images/histories/' . $history->image) }}" alt=""></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('histories.edit', $history->id) }}" class="btn btn-sm btn-info"
                                            title="تعديل"><i class="las la-pen"></i></a>
                                        @endcan
                                        @can('history-delete')
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $history->id }}" data-username="{{ $history->name }}"
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('histories.destroy',0) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="history_id" id="user_id" value="">
