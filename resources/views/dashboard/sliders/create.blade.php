...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('sliders.index') }}">جميع الخدمات</a>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('sliders.store') }}" class="needs-validation " enctype="multipart/form-data">
                        @csrf
