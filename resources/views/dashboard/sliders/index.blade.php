...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">عرض</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                العروض</span>
        </div>
    </div>
    @can('slide-create')
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('sliders.create') }}">اضافه عرض</a>
    </div>
    @endcan
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">صورة العرض</th>
                            ...
                            @if ($sliders->count()>0)
                             @foreach ($sliders as $slider)
                                <tr>
                                    ...
                                    <td><a href="{{ asset('images/sliders/' . $slider->image) }}" target="_blank"><img src="{{ asset('images/sliders/' . $slider->image) }}" alt=""></a></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $slider->id }}" data-username="{{ $slider->title }}"
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('sliders.destroy',0) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="slider_id" id="user_id" value="">
