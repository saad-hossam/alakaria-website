...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الفئات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                الفئات</span>
        </div>
    </div>
    @can('category-create')
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('categories.create') }}">اضافه فئه</a>
    </div>
    @endcan
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">اسم الفئه</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $category->id }}" data-username="{{ $category->name }}"
