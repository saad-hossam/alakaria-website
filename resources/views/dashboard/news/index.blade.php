...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">اﻷخبار</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                اﻷخبار</span>
        </div>
    </div>
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('news.create') }}">اضافه خبر</a>
    </div>
</div>
<!-- breadcrumb -->
@endsection
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">اسم الخبر</th>
                                <th class="wd-15p border-bottom-0">الوصف</th>
                                <th class="wd-15p border-bottom-0">المحتوى </th>
                                <th class="wd-15p border-bottom-0">صورة الخبر</th>
                                <th class="wd-15p border-bottom-0">حالة الخبر</th>
                            ...
                            @if ($news->count()>0)
                             @foreach ($news as $new)
                                <tr>
                                    ...
                                    <td><a href="{{ asset('images/news/' . $new->image) }}" target="_blank"><img src="{{ asset('images/news/' . $new->image) }}" alt=""></a></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('news.edit', $new->id) }}" class="btn btn-sm btn-info"
                                            title="تعديل"><i class="las la-pen"></i></a>
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $new->id }}" data-username="{!! $new->name !!}"
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('news.destroy',0) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="new_id" id="user_id" value="">
